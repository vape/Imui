...
namespace Imui.Style
{
    public static class ImStyleSheetBuilder
    {
        ...
        {
            Profiler.BeginSample("ImStyleSheetBuilder.Build");

            var sheet = new ImStyleSheet();
            
            // Theme
            sheet.Theme = theme;
            sheet.ReadOnlyColorMultiplier = theme.ReadOnlyColorMultiplier;
            
            // Text
            sheet.Text.Color = theme.Foreground;
            sheet.Text.Alignment = default;
            
            // Base
            sheet.Layout.ExtraRowHeight = theme.ExtraRowSize;
            sheet.Layout.ControlsSpacing = theme.Spacing;
            ...
            sheet.Window.ResizeHandleColor = D(theme.Background, 0.15f);
            sheet.Window.ResizeHandleSize = theme.ScrollBarSize * 1.3f;
            sheet.Window.Box.BorderRadius = theme.WindowBorderRadius;
            sheet.Window.Box.BorderWidth = theme.WindowBorderThickness;
            ...
            sheet.Button.BorderThickness = theme.BorderWidth;
            ...
            sheet.Button.Hovered.BackColor = theme.IsDark ? L(theme.ButtonColor, 0.3f) : L(theme.ButtonColor, 0.05f);
            sheet.Button.Hovered.FrontColor = L(theme.Foreground, 0.05f);
            sheet.Button.Hovered.BorderColor = L(theme.BorderColor, 0.05f);

            sheet.Button.Pressed.BackColor = theme.IsDark ? D(sheet.Button.Hovered.BackColor, 0.4f) : D(sheet.Button.Hovered.BackColor, 0.1f);
            sheet.Button.Pressed.FrontColor = D(theme.Foreground, 0.05f);
            sheet.Button.Pressed.BorderColor = D(theme.BorderColor, 0.05f);
            
            // Text Edit
            var textSelection = theme.AccentBackground.WithAlpha((byte)(255 * 0.25f));

            sheet.TextEdit.Normal.SelectionColor = textSelection;
            ...
            sheet.TextEdit.Normal.Box.BorderWidth = theme.BorderWidth;

            sheet.TextEdit.Selected.SelectionColor = textSelection;
            ...
            sheet.TextEdit.Selected.Box.BorderWidth = theme.BorderWidth;
            ...
            sheet.Scroll.Padding = theme.BorderWidth;
            ...
            sheet.Scroll.HoveredState.FrontColor = theme.IsDark ? L(sheet.Scroll.NormalState.FrontColor, 0.1f) : D(sheet.Scroll.NormalState.FrontColor, 0.1f);
            sheet.Scroll.PressedState.BackColor = sheet.Scroll.HoveredState.BackColor;
            sheet.Scroll.PressedState.FrontColor = theme.IsDark ? theme.AccentBackground : D(theme.AccentBackground, 0.1f);
            
            // Slider
            sheet.Slider.Box.BackColor = theme.FieldColor;
            sheet.Slider.Box.BorderColor = theme.BorderColor;
            sheet.Slider.Box.BorderWidth = theme.BorderWidth;
            sheet.Slider.Box.BorderRadius = theme.BorderRadius;
            sheet.Slider.Box.FrontColor = theme.Foreground;
            sheet.Slider.Handle.BorderRadius = Mathf.Max(0, theme.BorderRadius - theme.BorderWidth);

            sheet.Slider.Handle.Normal.BackColor = theme.IsDark ? D(theme.Foreground, 0.4f) : L(theme.Foreground, 3.0f); 
            ...
            sheet.List.Box.BorderWidth = theme.BorderWidth;
            ...
            sheet.List.ItemNormal.Pressed.BackColor = theme.IsDark ? theme.Foreground.WithAlpha(16) : theme.Foreground.WithAlpha(48);
            ...
            // Separator
            sheet.Separator.Thickness = theme.TextSize * 0.15f;
